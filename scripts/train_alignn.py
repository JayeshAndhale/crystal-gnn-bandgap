"""
Train ALIGNN on the crystal graphs (atom graph + line graph). Identical
training mechanics to train_cgcnn.py — same split logic, normalization,
loss, scheduler, checkpointing — only the model and data format differ.
"""
